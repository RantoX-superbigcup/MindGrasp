...
def load_config(path: str | Path) -> FrameworkConfig:
    ...
    return FrameworkConfig(
        ...
        dry_run=dry_run,
        qwen_dry_run=bool(data.get("qwen_dry_run", dry_run)),
        graspnet_dry_run=bool(data.get("graspnet_dry_run", dry_run)),
        planner_dry_run=bool(data.get("planner_dry_run", dry_run)),
        robot_dry_run=bool(data.get("robot_dry_run", dry_run)),
